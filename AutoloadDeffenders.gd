...
func _physics_process(_delta):
	 DeffendersCp = ClubmanCP + SwordManCP + MusketeerCP + InfantryCP + MechInfantryCP + BallistraCP + CannonCP + ArtilleryPieceCP + AntiAirCp \
+ PlaneLvl1CP + PlaneLvl2CP + BomberLvl1CP + BomberLvl2CP + IronCladCP + BattleShipLvl1CP + BattleShipLvl2CP
...
func _FortButtonPressValues():
	...
	if ModernEraCityBool == true:
		ModernEraCityBool = 70
	else : ModernEraCityBool = 0
